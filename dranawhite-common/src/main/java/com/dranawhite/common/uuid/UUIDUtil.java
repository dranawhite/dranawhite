package com.dranawhite.common.uuid;

import com.dranawhite.common.common.InetAddressUtil;
...
public final class UUIDUtil {
    ...
    public static String getTimedPatternUUID() {
        ...
        String time = DateUtil.format(DateUtil.today(), DateUtil.DateFormat.SERIAL_MILL_SECOND);
        ...
        sb.append(time.substring(2))
                ...
                .append(StringUtil.fillStringWithZero(indexStr, 6));
        return sb.toString();
    }
